...
SOURCES += src\images\SkDecodingImageGenerator.cpp
SOURCES += src\images\SkForceLinking.cpp
SOURCES += src\images\SkImageDecoder.cpp
SOURCES += src\images\SkImageDecoder_astc.cpp
SOURCES += src\images\SkImageDecoder_FactoryDefault.cpp
SOURCES += src\images\SkImageDecoder_FactoryRegistrar.cpp
SOURCES += src\images\SkImageDecoder_wbmp.cpp
